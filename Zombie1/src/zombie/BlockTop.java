...
public class BlockTop {
    ...
    public int textureId2 = 0;
    public String texturePath = "";
    public String texturePath2 = "";
    public boolean windAffected = false;
    public boolean cuurentlyTransparent = false;
    ...
    public BlockTop CreateNew()
    {
        BlockTop b = new BlockTop();
        b.name = this.name;
        b.value = this.value;
        b.textureId = this.textureId;
        b.textureId2 = this.textureId2;
        b.windAffected = this.windAffected;
        ...
        b.texturePath2 = this.texturePath2;
    ...
    public void breakBlock(Zombie z, Graphics g, int blockX, int blockY, Entity byEntity){
        ...
        new WorldAccessor().GetBlock(z, blockX, blockY, byEntity.chunkLayer, byEntity.onMap).blocktop = null;
