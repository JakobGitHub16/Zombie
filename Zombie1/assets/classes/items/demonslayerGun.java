...
public class demonslayerGun extends Item {

    int time = 0;
    int beamlength = 50;
    public boolean breakOnWalls = false;
    
    public demonslayerGun() {
        super();
        this.type = "ranged";
    }
    ...
    public void LeftClickUse(Zombie z, int targetX, int targetY, Graphics g, Entity usingEntity) {
            ...
            for (int a = 0; a <= z.projectile.length - 1; a++) {
                if (z.projectile[a] == null) {
                    ...
                    z.projectile[a] = new WorldAccessor().getProjectile(z, "beamprojectileDemonslayerGun");
    ...
    @Override
    public demonslayerGun CreateNew(){
        
        demonslayerGun i = new demonslayerGun();
        i.name = this.name;
