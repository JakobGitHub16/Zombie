...
public class torch extends Item {
    ...
    { 
        ...
        w.SetBlock(z, "BlockGround", "torch", (int)((targetX + z.Z) / 60), (int)((targetY + z.Q) / 60), usingEntity.chunkLayer, usingEntity.onMap);
        w.refreshLight(z, (int)((targetX + z.Z) / 60), (int)((targetY + z.Q) / 60), usingEntity.chunkLayer, usingEntity.onMap);
