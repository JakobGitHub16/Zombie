...
public class cobblestone extends Item {
    ...
    { 
        ...
        new WorldAccessor().SetBlock(z, "BlockGround", "cobblestone", (int)((targetX + z.Z) / 60), (int)((targetY + z.Q) / 60), usingEntity.chunkLayer, usingEntity.onMap);
    ...
    @Override
    public cobblestone CreateNew(){
        
        cobblestone i = new cobblestone();
        i.image = this.image;
