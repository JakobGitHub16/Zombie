...
public class dungeonOutrance extends Item {

    public int pickPower = 50;
    
    public dungeonOutrance() {
        super();
        this.type = "melee";
    }
    ...
    { 
        ...
        new WorldAccessor().SetBlock(z, "BlockNormal", "dungeonOutrance", (int)((targetX + z.Z) / 60), (int)((targetY + z.Q) / 60), usingEntity.chunkLayer, usingEntity.onMap);
    ...
    public dungeonOutrance CreateNew(){
    	...
    	dungeonOutrance i = new dungeonOutrance();
        i.image = this.image;
