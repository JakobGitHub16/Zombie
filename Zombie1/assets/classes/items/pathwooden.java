...
public class pathwooden extends Item {
    ...
    { 
        ...
        new WorldAccessor().SetBlock(z, "BlockGround", "pathwooden", (int)((targetX + z.Z) / 60), (int)((targetY + z.Q) / 60), usingEntity.chunkLayer, usingEntity.onMap);
    ...
    @Override
    public pathwooden CreateNew(){
        
        pathwooden i = new pathwooden();
        i.image = this.image;
