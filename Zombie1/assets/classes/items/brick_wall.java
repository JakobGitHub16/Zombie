...
public class brick_wall extends Item {
    ...
    { 
        ...
        new WorldAccessor().SetBlock(z, "BlockGround", "brick_wall", (int)((targetX + z.Z) / 60), (int)((targetY + z.Q) / 60), usingEntity.chunkLayer, usingEntity.onMap);
    ...
    @Override
    public brick_wall CreateNew(){
        
        brick_wall i = new brick_wall();
        i.image = this.image;
