...
public class pathstone extends Item {
    ...
    { 
        ...
        new WorldAccessor().SetBlock(z, "BlockGround", "pathstone", (int)((targetX + z.Z) / 60), (int)((targetY + z.Q) / 60), usingEntity.chunkLayer, usingEntity.onMap);
    ...
    @Override
    public pathstone CreateNew(){
        
        pathstone i = new pathstone();
        i.image = this.image;
